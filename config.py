...
def load_args_reduce():
    ...
    parser.add_argument('--model_path', type=str, default='output/model/saved_model_binary.pt')
    ...
    parser.add_argument('--output_lib_path', type=str, default='output/reduced_lib_test.parquet')
...
def load_args_finetune():
    ...
    parser.add_argument('--path_dataset_train', type=str, default='output/dataset_train_binary.csv')
    # Path to validation dataset
    parser.add_argument('--path_dataset_val', type=str, default='output/dataset_test_binary.csv')
    ...
    parser.add_argument('--save_model_path', type=str, default='output/model/saved_model_binary.pt')
    parser.add_argument('--batch_size', type=int, default=16)
    # Path to the training and validation metrics report
    parser.add_argument('--report_path', type=str, default='output/report_path_binary')
    # Name of the model in training/validation report
    parser.add_argument('--model_name', type=str, default='output/model/model_finetuned_binary')
